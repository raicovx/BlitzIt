...
interface PurposeDAO
{
    ...
    @Transaction
    @Query("SELECT * FROM Purpose WHERE plan_id = :planID AND ndisNumber = :ndisNumber ORDER BY purpose_position ASC")
    suspend fun getPurposesWithCategories(planID: String, ndisNumber: Int): List<PurposeWithCategories>
}